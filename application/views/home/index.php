	...
	<div id="page">
							...
							<div class="top">
								<div class="row">
									<div class="col-md-4 col-md-push-4 text-center">
										<div id="qbootstrap-logo"><a href="index-2.html"><i class="icon-plus-outline"></i>ICOFA<span>2019</span></a></div>
									</div>
									...
									<div class="col-md-4">
										<div class="loc">
											...
											<p><a href="#">2nd – 3rd November 2019 <br> BNDCC Bali</a></p>
										</div>
									</div>
								</div>
							</div>
		...
		<div id="qbootstrap-intro">
			<div class="row">
				<div class="intro animate-box">
					<div class="intro-grid color-1 col-lg-6">
					...
					<div class="intro-grid color-2 col-lg-6">
		...
		<div id="qbootstrap-choose">
			<div class="container-fluid">
				<div class="row">
					<div class="choose">
						<div class="half img-bg" style="background-image: url(<?= base_url('assets/'); ?>images/img_bg_6.jpg);"></div>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-3 animate-box text-center">
						<div class="doctor">
							<div class="staff-img" style="background-image: url(<?= base_url('assets/'); ?>images/staff-4.jpg);"></div>
					...
					<div class="col-md-3 animate-box text-center">
						<div class="doctor">
							<div class="staff-img" style="background-image: url(<?= base_url('assets/'); ?>images/staff-2.jpg);"></div>
					...
					<div class="col-md-3 animate-box text-center">
						<div class="doctor">
							<div class="staff-img" style="background-image: url(<?= base_url('assets/'); ?>images/staff-3.jpg);"></div>
					...
					<div class="col-md-3 animate-box text-center">
						<div class="doctor">
							<div class="staff-img" style="background-image: url(<?= base_url('assets/'); ?>images/staff-1.jpg);"></div>
		...
		<div id="qbootstrap-counter" class="qbootstrap-counters" style="background-image: url(<?= base_url('assets/'); ?>images/img_bg_2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
							...
							<div class="owl-carousel owl-carousel-fullwidth">
								<div class="item">
									<div class="blog-slide active">
										<a href="blog.html" class="blog-box" style="background-image: url(<?= base_url('assets/'); ?>images/blog-1.jpg);">
								...
								<div class="item">
									<div class="blog-slide active">
										<a href="blog.html" class="blog-box" style="background-image: url(<?= base_url('assets/'); ?>images/blog-2.jpg);">
											<span class="date">Aug 20, 2017</span>
										</a>
										<div class="desc">
								...
								<div class="item">
									<div class="blog-slide active">
										<a href="blog.html" class="blog-box" style="background-image: url(<?= base_url('assets/'); ?>images/blog-3.jpg);">
											<span class="date">Aug 20, 2017</span>
										</a>
										<div class="desc">
		...
		<div id="qbootstrap-register" style="background-image: url(<?= base_url('assets/'); ?>images/img_bg_5.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
