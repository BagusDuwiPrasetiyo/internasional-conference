<div class="slide-one-item home-slider owl-carousel">
	<div class="site-blocks-cover inner-page overlay" style="background-image: url(<?= base_url('assets/'); ?>images/hero_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
		<div class="container">
	...
	<div class="site-blocks-cover inner-page overlay" style="background-image: url(<?= base_url('assets/'); ?>images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row align-items-center justify-content-center">
...
<div class="site-half block">
	<div class="img-bg-1 right" style="background-image: url('<?= base_url('assets/'); ?>images/img_5.jpg');" data-aos="fade"></div>
	<div class="container">
		<div class="row no-gutters align-items-stretch">
...
<div class="site-section section-counter">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
				<p class="mb-5"><img src="<?= base_url('assets/'); ?>images/img_1.jpg" alt="Image" class="img-fluid"></p>
			</div>
